# Assign Jira Issue hello test!!! hi
...
This document provides comprehensive documentation for the `Assign Jira Issue hello test!!! hi` workflow.
...
| `assignee_email` | `string` | ✅ Yes | `_not set_` | Assignee email in Jiraaaa |
...
```yaml
name: Assign Jira Issue hello test!!! hi
on:
  workflow_dispatch:
    inputs:
      issue_key:
        ...
        required: true
      assignee_email:
        description: 'Assignee email in Jiraaaa'
        required: true
...
**Generated on:** 2025-12-02 13:19:51 UTC
