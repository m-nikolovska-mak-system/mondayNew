# Assign Jira Issue 🚀 hi testing hello testing again
...
This document provides comprehensive documentation for the `Assign Jira Issue 🚀 hi testing hello testing again` workflow.
...
```yaml
name: Assign Jira Issue 🚀 hi testing hello testing again
on:
  workflow_dispatch:
    inputs:
      issue_key:
...
**Generated on:** 2025-12-12 11:18:30 UTC
