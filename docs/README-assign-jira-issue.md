# Assign Jira Issue 🚀 hi testing hello testing again version 2
...
This document provides comprehensive documentation for the `Assign Jira Issue 🚀 hi testing hello testing again version 2` workflow.
...
```yaml
name: Assign Jira Issue 🚀 hi testing hello testing again version 2
on:
  workflow_dispatch:
    inputs:
      issue_key:
...
**Generated on:** 2025-12-16 09:48:20 UTC
