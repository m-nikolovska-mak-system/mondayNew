...
**Source:** `teams-notify-template.yml`
...
| --- | --- | --- | --- | --- |
| notification_title | string | no | 🚀 Files Updated | Title for the Teams card |
| action_required_message | string | no | ⚠️ **Action Required:** Please review changes | Custom action message |
| card_color | string | no | Accent | Accent color theme (Accent, Good, Warning, Attention) |
| files | string | no |  | List of changed files |
  ...
  workflow_call:
    inputs:
      ...
      action_required_message:
        ...
        required: false
        type: string
        default: '⚠️ **Action Required:** Please review changes'
      card_color:
            ...
            "attachments": [
              {
                ...
                "content": {
                  ...
                  "body": [
                    ...
                    {
                      "type": "TextBlock",
                      "text": "🔗 Commit: https://github.com/$REPO/commit/$SHA"
                    },
                    {
                      "type": "TextBlock",
