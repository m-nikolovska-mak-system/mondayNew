# Generate Workflow Documentation version 3

**Source:** `workflow-doc-generator-v2.yml`
...
| List all workflows |  | `run` command |
...
## Full YAML
```yaml
name: Generate Workflow Documentation version 3
              ...
              if 'on' in workflow and isinstance(workflow['on'], dict) and 'workflow_call' in workflow['on']:
                  ...
                  if 'outputs' in call_config and call_config['outputs']:
                      ...
                      for output_name in call_config['outputs'].keys():
                          ...
                          # Escape the curly braces properly for the example
