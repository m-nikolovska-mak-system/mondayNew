...
| name | action | run |
| --- | --- | --- |
| Setup Node.js ${{ matrix.node }} | actions/setup-node@v3 |  |
| Print Environment |  | `run` command |

### validate-inputs

| name | action | run |
| --- | --- | --- |
| Check dry-run input |  | `run` command |

### use-secrets

| name | action | run |
| --- | --- | --- |
| Print secret (simulated) |  | `run` command |

### conditional-step

| name | action | run |
| --- | --- | --- |
| Run only in dev |  | `run` command |

### concurrency-test

| name | action | run |
| --- | --- | --- |
| Simulate long task |  | `run` command |
