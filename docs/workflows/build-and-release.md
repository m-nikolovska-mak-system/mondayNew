...
| Build JAR | m-nikolovska-mak-system/reusable-actions-library/.github/workflows/build-jar.yml@main |  |
...
| --- | --- | --- |
| Checkout code | actions/checkout@v4 |  |
| Detect ISS setup script | m-nikolovska-mak-system/reusable-actions-library/.github/workflows/detect-setup-script.yml@main |  |

### validate_inputs

| name | action | run |
| --- | --- | --- |
| Validate JAR cache key |  | `run` command |
| Validate JAR path |  | `run` command |
...
| --- | --- | --- |
| Checkout code | actions/checkout@v4 |  |
| Build installer | m-nikolovska-mak-system/reusable-actions-library/.github/workflows/build-installer.yml@main |  |
...
| --- | --- | --- |
| Checkout code | actions/checkout@v4 |  |
| Upload to release | m-nikolovska-mak-system/reusable-actions-library/.github/workflows/upload-release.yml@main |  |
