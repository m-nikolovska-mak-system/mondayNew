...
| --- | --- | --- | --- | --- |
| jar-key | string | yes |  | Cache key for the JAR file |
| release_tag | string | yes |  | Tag name of the release |
...
| Download built JAR from previous workflow | actions/download-artifact@v4 |  |
