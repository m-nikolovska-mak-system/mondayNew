...
jobs:
  ...
  notify-teams:
    ...
    with:
      notification_title: ${{ github.event_name == 'workflow_dispatch' && inputs.test_message || '✅ Code Pushed to Main' }}
      action_required_message: ${{ github.event_name == 'workflow_dispatch' && '🧪 This is a test notification. Everything is working!' || '📝 New changes have been pushed. Please review if needed.' }}
